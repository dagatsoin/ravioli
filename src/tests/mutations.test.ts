...
import { DEPRECATED_object } from "../src/vendor/crafter/src/Object";
import { array } from "../src/vendor/crafter/src/Array";
...
test("Mutations are permitted during a presentation.", function() {
  ...
  expect(Model.data.inventory[0].$patch.length).toBe(0);
});
 */
